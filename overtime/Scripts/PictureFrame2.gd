...
func _on_interacted(body: Variant) -> void:
	...
	if not PlayerManager.examed:
		PlayerManager.CharacterHintDialog("I feel like I've had this forever","Press A or D to rotate object while examing")
		PlayerManager.examed = true
	elif PlayerManager.DeskItems.size() == 3 and not PlayerManager.has_item("Car Keys"):
		PlayerManager.CharacterHintDialog("I feel like I've had this forever","I should grab my keys and get out of here")
	else:
		PlayerManager.CharacterDialog("I feel like I've had this forever")
